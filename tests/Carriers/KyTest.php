...
final class KyTest extends TestCase
{
    public function testQueryTrackParses(): void
    {
        ...
        $http->handler = function (Request $request) {
            ...
            $this->assertSame('KY1234567890', $body['trackingNo']);

            return new Response(200, ['Content-Type' => 'application/json'],
                file_get_contents(__DIR__ . '/../fixtures/ky/track.json'));
        };

        $adapter = new Ky(
            new Config(['ky' => ['app_key' => 'test-app-key', 'app_secret' => 'test-app-secret']]),
            $http,
        );

        $tracking = $adapter->queryTrack('KY1234567890');
    ...
    public function testUnauthorizedThrowsAuthException(): void
    {
        ...
        $adapter->queryTrack('KY1234567890');
    }
    ...
    public function testServerErrorThrowsLogisticsException(): void
    {
        ...
        try {
            ...
            $this->assertStringContainsString('[KY 500]', $e->getMessage());
        }
    }
    ...
    public function testNoTracesThrowsTrackingNotFoundException(): void
    {
        ...
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            json_encode(['code' => 200, 'msg' => 'ok', 'data' => ['traces' => []]], JSON_UNESCAPED_UNICODE));
