...
final class ZhongtieTest extends TestCase
{
    private function makeAdapter(FakeHttpClient $http): Zhongtie
    {
        return new Zhongtie(
            new Config(['zhongtie' => [
    ...
    public function testQueryTrackParses(): void
    {
        ...
        $http->handler = function (Request $request) {
            ...
            $this->assertSame('ZTWL', $requestData['ShipperCode']);
            ...
            return new Response(200, ['Content-Type' => 'application/json'],
                file_get_contents(__DIR__ . '/../fixtures/zhongtie/track.json'));
        };

        $tracking = $this->makeAdapter($http)->queryTrack('123456789012');

        $this->assertSame('zhongtie', $tracking->carrierCode);
        $this->assertSame('123456789012', $tracking->trackingNo);
        $this->assertSame(TrackStatus::DELIVERED, $tracking->status);
        $this->assertCount(4, $tracking->events);
        $this->assertSame('中铁物流已揽收', $tracking->events[0]->description);
        ...
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            json_encode([
                ...
                'Traces' => [
                    ...
                    ['AcceptTime' => '2026-08-12 09:30:00', 'AcceptStation' => '中铁物流已揽收', 'Remark' => ''],
                ],
    ...
    public function testQueryTrackThrowsWhenNoEvents(): void
    {
        $http = new FakeHttpClient();
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/zhongtie/empty.json'));
    ...
    public function testQueryTrackMapsBusinessError(): void
    {
        ...
        $http->handler = fn (Request $request) => new Response(400, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/zhongtie/error.json'));

        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[ZHONGTIE 400] 接口错误');
    ...
    public function testQueryTrackMapsAuthError(): void
    {
        ...
        $this->expectExceptionMessage('[ZHONGTIE 401] 认证失败');
    ...
    public function testQueryTrackThrowsOnInvalidJson(): void
    {
        ...
        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[ZHONGTIE] 响应解析失败');
    ...
    public function testUnsupportedMethodsThrow(): void
    {
        ...
        try {
            ...
            $this->assertSame('zhongtie createOrder 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('zhongtie createLabel 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('zhongtie subscribe 待实现', $e->getMessage());
        }
    }
}
