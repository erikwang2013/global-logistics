...
final class QuanfengTest extends TestCase
{
    private function makeAdapter(FakeHttpClient $http): Quanfeng
    {
        return new Quanfeng(
            new Config(['quanfeng' => [
    ...
    public function testQueryTrackParses(): void
    {
        ...
        $http->handler = function (Request $request) {
            ...
            $this->assertSame('QFKD', $requestData['ShipperCode']);
            ...
            return new Response(200, ['Content-Type' => 'application/json'],
                file_get_contents(__DIR__ . '/../fixtures/quanfeng/track.json'));
        };

        $tracking = $this->makeAdapter($http)->queryTrack('123456789012');

        $this->assertSame('quanfeng', $tracking->carrierCode);
        $this->assertSame('123456789012', $tracking->trackingNo);
        $this->assertSame(TrackStatus::DELIVERED, $tracking->status);
        $this->assertCount(4, $tracking->events);
        $this->assertSame('全峰快递已揽收', $tracking->events[0]->description);
        ...
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            json_encode([
                ...
                'Traces' => [
                    ...
                    ['AcceptTime' => '2026-08-12 09:30:00', 'AcceptStation' => '全峰快递已揽收', 'Remark' => ''],
                ],
    ...
    public function testQueryTrackThrowsWhenNoEvents(): void
    {
        $http = new FakeHttpClient();
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/quanfeng/empty.json'));
    ...
    public function testQueryTrackMapsBusinessError(): void
    {
        ...
        $http->handler = fn (Request $request) => new Response(400, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/quanfeng/error.json'));

        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[QUANFENG 400] 接口错误');
    ...
    public function testQueryTrackMapsAuthError(): void
    {
        ...
        $this->expectExceptionMessage('[QUANFENG 401] 认证失败');
    ...
    public function testQueryTrackThrowsOnInvalidJson(): void
    {
        ...
        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[QUANFENG] 响应解析失败');
    ...
    public function testUnsupportedMethodsThrow(): void
    {
        ...
        try {
            ...
            $this->assertSame('quanfeng createOrder 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('quanfeng createLabel 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('quanfeng subscribe 待实现', $e->getMessage());
        }
    }
}
