...
final class XinbangTest extends TestCase
{
    private function makeAdapter(FakeHttpClient $http): Xinbang
    {
        return new Xinbang(
            new Config(['xinbang' => [
    ...
    public function testQueryTrackParses(): void
    {
        ...
        $http->handler = function (Request $request) {
            ...
            $this->assertSame('XBWL', $requestData['ShipperCode']);
            ...
            return new Response(200, ['Content-Type' => 'application/json'],
                file_get_contents(__DIR__ . '/../fixtures/xinbang/track.json'));
        };

        $tracking = $this->makeAdapter($http)->queryTrack('123456789012');

        $this->assertSame('xinbang', $tracking->carrierCode);
        $this->assertSame('123456789012', $tracking->trackingNo);
        $this->assertSame(TrackStatus::DELIVERED, $tracking->status);
        $this->assertCount(4, $tracking->events);
        $this->assertSame('新邦物流已揽收', $tracking->events[0]->description);
        ...
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            json_encode([
                ...
                'Traces' => [
                    ...
                    ['AcceptTime' => '2026-08-12 09:30:00', 'AcceptStation' => '新邦物流已揽收', 'Remark' => ''],
                ],
    ...
    public function testQueryTrackThrowsWhenNoEvents(): void
    {
        $http = new FakeHttpClient();
        $http->handler = fn (Request $request) => new Response(200, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/xinbang/empty.json'));
    ...
    public function testQueryTrackMapsBusinessError(): void
    {
        ...
        $http->handler = fn (Request $request) => new Response(400, ['Content-Type' => 'application/json'],
            file_get_contents(__DIR__ . '/../fixtures/xinbang/error.json'));

        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[XINBANG 400] 接口错误');
    ...
    public function testQueryTrackMapsAuthError(): void
    {
        ...
        $this->expectExceptionMessage('[XINBANG 401] 认证失败');
    ...
    public function testQueryTrackThrowsOnInvalidJson(): void
    {
        ...
        $this->expectException(LogisticsException::class);
        $this->expectExceptionMessage('[XINBANG] 响应解析失败');
    ...
    public function testUnsupportedMethodsThrow(): void
    {
        ...
        try {
            ...
            $this->assertSame('xinbang createOrder 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('xinbang createLabel 待实现', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('xinbang subscribe 待实现', $e->getMessage());
        }
    }
}
